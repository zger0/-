...
public class NoticeListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new PostService().selectNoticeListCount();
		...
		ArrayList<Post> list = new PostService().selectNoticeList(pi);
		...
		request.getRequestDispatcher("views/post/noticeListView.jsp").forward(request, response);
