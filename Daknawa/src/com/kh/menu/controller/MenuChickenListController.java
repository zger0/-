...
/**
 * Servlet implementation class MenuChickenListController
 */
@WebServlet("/list.ch")
public class MenuChickenListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MenuChickenListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // * listCount : 총 게시글의 갯수
	    listCount = new MenuService().selectListCount(type);
	  ...
	  */
	    ...
	    ArrayList<Menu> list = new MenuService().selectPageChList(pi, type);
	    ArrayList<Attachment>  ilist = new MenuService().selectImgPageChList(pi, type);
	    ...
	    request
	      .getRequestDispatcher("views/menu/menuChView.jsp")
