...
/**
 * Servlet implementation class MenuEtcController
 */
@WebServlet("/list.etc")
public class MenuEtcController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MenuEtcController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ArrayList<Menu> list = new MenuService().selectPageEtcList(pi);

	    request.setAttribute("list", list);
	    request.setAttribute("pi", pi);

	    request
	      .getRequestDispatcher("views/menu/menuEtcView.jsp")
