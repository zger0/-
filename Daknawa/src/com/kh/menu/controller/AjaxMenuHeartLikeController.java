...
/**
 * Servlet implementation class MenuHeartController
 */
@WebServlet("/heartLike.mn")
public class AjaxMenuHeartLikeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxMenuHeartLikeController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 new MenuService().insertHeart(mbno, mno);
	}
