...
/**
 * Servlet implementation class MenuTteokbController
 */
@WebServlet("/list.tt")
public class MenuTteokbController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MenuTteokbController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ArrayList<Menu> list = new MenuService().selectPageTtList(pi);

	    request.setAttribute("list", list);
	    request.setAttribute("pi", pi);

	    request
	      .getRequestDispatcher("views/menu/menuTtView.jsp")
