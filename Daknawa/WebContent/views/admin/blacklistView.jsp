...
<body>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>블랙리스트 목록</h2>
                            <p>블랙리스트에 등록되어있는 회원의 정보, 블랙리스트 해제</p>
                        </div>
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr onclick="get1(this);">
                                        ...
                                        <td><%= m.getEmail() %></td>
                                        <td><%= m.getPhone() %></td>
                                        <td onclick="unBlacklist(<%= m.getUserNo() %>);">해제</td>
    ...
    <script>
    	...
    	function unBlacklist(mno) {
    		
    		toggle = 1;
    		
    		let answer = confirm("블랙리스트에서 해제하시겠습니까?");
    			...
    			$.ajax({
        			...
        			success : function(result) {
        				...
        				if(result > 0) {
        					...
        					alert("블랙리스트 해제에 실패하였습니다. 다시 시도해주세요.");				
        				}
        			},
        			error : function() {
        				alert("블랙리스트 해제에 실패하였습니다. 다시 시도해주세요.");
