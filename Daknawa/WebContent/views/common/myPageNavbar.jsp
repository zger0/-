		    ...
		    <div class="mnb_header">
		        <ul id="mnb_sub">
	            	<li class="<%= sn.getActive1() %>">
	                    <a href="myInfo.me">내 정보 관리</a>
	                    <ul>
	                        <li style="display: block !important;"><a href="myInfo.me">정보 조회 및 수정</a></li>
	                        <li style="display: block !important;"><a href="deleteForm.me">회원 탈퇴</a></li>                   
	                    </ul>
	                </li>
